...
@onready var akane_mana_bar: ColorRect = $CenterContainer/HUD/Boss/AkaneManaBar
@onready var akane_mana_bar_background: ColorRect = $CenterContainer/HUD/Boss/AkaneBaseBar
